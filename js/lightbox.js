...
(function() {
  ...
  var LightboxOptions = (function() {
    ...
    LightboxOptions.prototype.albumLabel = function(curImageNum, albumSize) {
      return "Response " + curImageNum + " of " + albumSize;
    };
  ...
  var Lightbox = (function() {
    ...
    Lightbox.prototype.build = function() {
      var self = this;
      $("<div id='lightboxOverlay' class='lightboxOverlay'></div><div id='lightbox' class='lightbox'><div class='lb-outerContainer'><div class='lb-container'><img class='lb-image' src='' /><div class='lb-nav'><a class='lb-prev' href='' ></a><a class='lb-next' href='' ></a></div><div class='lb-loader'><a class='lb-cancel'></a></div></div></div><div class='lb-dataContainer'><div class='lb-data'><div class='lb-details'><span class='lb-caption' style='display: block;'></span><span class='lb-number'></span><button type='button' class='button-correct'>Correct</button><button type='button'  class='button-incorrect'>Incorrect</button></div><div class='lb-closeContainer'><a class='lb-close'></a></div></div></div></div>").appendTo($('body'));
