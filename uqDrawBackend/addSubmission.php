...
$questionQuery = "SELECT `courseID`,`questionWeek`,`status` FROM `Question` WHERE `questionID`=$questionID";
...
if ($status == 1) {
    ...
    //try put image in server first, if fail, whole procress abandon
    ...
    echo "Cannot Submit, Question is closed";
}
